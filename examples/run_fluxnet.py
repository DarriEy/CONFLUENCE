...
def main():
    ...
    csv_path = "fluxnet_transformed.csv"
    
    # Path to the template config file
    template_config_path = "../CONFLUENCE/0_config_files/config_point_template.yaml"
    ...
    if submit_jobs == 'y':
        for _, watershed in watersheds.iterrows():
            ...
            simulation_dir = Path(f"/work/comphyd_lab/data/CONFLUENCE_data/fluxnet/domain_{domain_name}")#/simulations")
