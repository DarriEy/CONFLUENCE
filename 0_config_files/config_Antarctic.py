...
### ============================================= 1. Global settings: =====================================================================
# Main paths
CONFLUENCE_DATA_DIR: "/work/comphyd_lab/data/CONFLUENCE_data"
...
MPI_PROCESSES: 20                                               # Number of parallel processes allowed, based on your system's capabilities
...
STREAM_THRESHOLD: 7500                                         # Threshold flow accumulation for stream vectorisation
...
DELINEATE_BY_POURPOINT: False                                   # Delineate watershed from pour point
...
MIN_HRU_SIZE: 0                                                # Minimum HRU size in km^2
...
SOURCE_GEOFABRIC_BASINS_PATH: /project/6079554/data/geospatial-data/MERIT-Basins/MERIT_Hydro_v07_Basins_v01_bugfix1/pfaf_level_02/cat_pfaf_71_MERIT_Hydro_v07_Basins_v01_bugfix1.shp                                   # Path to source geofabric basins
SOURCE_GEOFABRIC_RIVERS_PATH: /project/6079554/data/geospatial-data/MERIT-Basins/MERIT_Hydro_v07_Basins_v01_bugfix1/pfaf_level_02/riv_pfaf_71_MERIT_Hydro_v07_Basins_v01_bugfix1.shp                                  # Path to source geofabric rivers
...
TOOL_CACHE: /work/comphyd_lab/users/darri/cache                                      # Path to gistool cache directory
EASYMORE_CACHE: /work/comphyd_lab/users/darri/cache                          # Path to easymore cache directory
...
# Soil attribute data paths
ATTRIBUTES_SOILGRIDS_PATH: "/work/comphyd_lab/data/_to-be-moved/NorthAmerica_geospatial/soilgrids"  # Will use {data_dir}/geospatial-data/soilgrids
ATTRIBUTES_PELLETIER_PATH: default  # Will use {data_dir}/geospatial-data/pelletier

# Topographic attribute data paths
ATTRIBUTES_MERIT_PATH: default # Will use {data_dir}/geospatial-data/merit

# Land cover attribute data paths
...
# Geology attribute data paths (new)
...
# Hydrology attribute data paths (new)
...
# Open water attribute data paths (new)
...
# Experiment settings
EXPERIMENT_TIME_START: 2018-01-01 01:00                        # Start time of experiment e.g. '2010-01-01 00:00'
EXPERIMENT_TIME_END: 2018-12-31 23:00                          # End time of experiment e.g. '2010-12-31 23:00'
...
FORCING_START_YEAR: "2018"                                     # Forcing start year
FORCING_END_YEAR: "2018"                                       # Forcing end year 
FORCING_VARIABLES: longitude,latitude,time,LWRadAtm,SWRadAtm,pptrate,airpres,airtemp,spechum,windspd  # Forcing dataset variables to use or acquire                                                                      
...
## Simulation settings
SIM_REACH_ID: 81023042                                              # River reach ID used for streamflow evaluation and optimization
